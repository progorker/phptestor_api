...
function \phptestor\api_testor_not_contains( $p_token, &$p_id, $p_suite_id, $p_case_id, $p_code, $p_operand, $p_value ) {
}
...
Token: 9712b2dc9c173bafee837ab35472dc2a
...
$) $test_id = -1; $test_code = 'not_contains.1'; $str_a = 'Hello world!'; $str_b = 'community'; \phptestor\api_testor_not_contains( $token, $test_id, $suite_id, $case_id, $test_code, $str_a, $str_b ); echo "\n", "Test ID: ", $test_id, "\n";
