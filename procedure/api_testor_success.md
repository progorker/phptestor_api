...
function \phptestor\api_testor_success( $p_token, $p_suite_id, $p_page_no, &$p_results, $p_beauty = false ) {
}
...
Token: 23345bd13afd2b4f88152bd46de90682
...
$) $test_id = -1; $test_code = 'greater.1'; $condition = 4 > 3; \phptestor\api_testor_true( $token, $test_id, $suite_id, $case_id, $test_code, $condition ); echo "\n", "Test ID: ", $test_id, "\n";
