...
function \phptestor\api_testor_less_than( $p_token, &$p_id, $p_suite_id, $p_case_id, $p_code, $p_operand, $p_value ) {
}
...
Token: 404e29bebac73837dcf062eeea68a0ca
...
$) $test_id = -1; $test_code = 'less_than.1'; $dbl_a = 2.5; $dbl_b = 3.5; \phptestor\api_testor_less_than( $token, $test_id, $suite_id, $case_id, $test_code, $dbl_a, $dbl_b ); echo "\n", "Test ID: ", $test_id, "\n";
