...
function \phptestor\api_testor_not_greater_than( $p_token, &$p_id, $p_suite_id, $p_case_id, $p_code, $p_operand, $p_value ) {
}
...
Token: 6ae0892c13337027a736cf22df38df5d
...
$) $test_id = -1; $test_code = 'not_greater_than.1'; $dbl_a = 2.5; $dbl_b = 3.5; \phptestor\api_testor_not_greater_than( $token, $test_id, $suite_id, $case_id, $test_code, $dbl_a, $dbl_b ); echo "\n", "Test ID: ", $test_id, "\n";
