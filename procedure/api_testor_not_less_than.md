...
function \phptestor\api_testor_not_less_than( $p_token, &$p_id, $p_suite_id, $p_case_id, $p_code, $p_operand, $p_value ) {
}
...
Token: f2643b2a93b76f0e3965fe634ee72a65
...
$) $test_id = -1; $test_code = 'not_less_than.1'; $dbl_a = 3.5; $dbl_b = 2.5; \phptestor\api_testor_not_less_than( $token, $test_id, $suite_id, $case_id, $test_code, $dbl_a, $dbl_b ); echo "\n", "Test ID: ", $test_id, "\n";
