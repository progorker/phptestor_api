...
function \phptestor\api_testor_not_true( $p_token, &$p_id, $p_suite_id, $p_case_id, $p_code, $p_condition ) {
}
...
Token: 59f1c65a7719f769a134b05fc17e2f3c
...
$) $test_id = -1; $test_code = 'greater.1'; $condition = 4 > 3; \phptestor\api_testor_not_true( $token, $test_id, $suite_id, $case_id, $test_code, $condition ); echo "\n", "Test ID: ", $test_id, "\n";
...
| case         | test      | message                                                                  |
+--------------+-----------+--------------------------------------------------------------------------+
| test_numbers | greater.1 | [greater.1] test (not_true) is failed. \nCondition: 1\nExpected: false\n |
+--------------+-----------+--------------------------------------------------------------------------+
