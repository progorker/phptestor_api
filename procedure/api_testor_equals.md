...
function \phptestor\api_testor_equals( $p_token, &$p_id, $p_suite_id, $p_case_id, $p_code, $p_operand, $p_value ) {
}
...
Token: 947f63320e8711f39a019ab85fbaa02d
...
$) $test_id = -1; $test_code = 'equals.1'; $dbl_a = 2.5; $dbl_b = 2.5; \phptestor\api_testor_equals( $token, $test_id, $suite_id, $case_id, $test_code, $dbl_a, $dbl_b ); echo "\n", "Test ID: ", $test_id, "\n";
