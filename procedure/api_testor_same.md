...
function \phptestor\api_testor_same( $p_token, &$p_id, $p_suite_id, $p_case_id, $p_code, $p_operand, $p_value ) {
}
...
Token: 07e87e1e70f0e27e5cb7a91bd5be879b
...
$) $test_id = -1; $test_code = 'same.1'; $str_a = 'Hello world!'; $str_b = 'Hello world!'; \phptestor\api_testor_same( $token, $test_id, $suite_id, $case_id, $test_code, $str_a, $str_b ); echo "\n", "Test ID: ", $test_id, "\n";
