...
function \phptestor\api_testor_contains( $p_token, &$p_id, $p_suite_id, $p_case_id, $p_code, $p_operand, $p_value ) {
}
...
Token: 72fecbdd0c22cb394ab14b61b95fb58f
...
$) $test_id = -1; $test_code = 'contains.1'; $str_a = 'Hello world!'; $str_b = 'world'; \phptestor\api_testor_contains( $token, $test_id, $suite_id, $case_id, $test_code, $str_a, $str_b ); echo "\n", "Test ID: ", $test_id, "\n";
