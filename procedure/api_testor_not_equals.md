...
function \phptestor\api_testor_not_equals( $p_token, &$p_id, $p_suite_id, $p_case_id, $p_code, $p_operand, $p_value ) {
}
...
Token: a5ac75003713d91965284f55ac40c55a
...
$) $test_id = -1; $test_code = 'not_equals.1'; $dbl_a = 3.5; $dbl_b = 2.5; \phptestor\api_testor_not_equals( $token, $test_id, $suite_id, $case_id, $test_code, $dbl_a, $dbl_b ); echo "\n", "Test ID: ", $test_id, "\n";
